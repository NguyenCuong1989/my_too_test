...
var i_38403 = (0);
while(true){
if((i_38403 < arr.length)){
(arr[i_38403] = null);

var G__38404 = (i_38403 + (1));
i_38403 = G__38404;
continue;
} else {
}
...
var i_38411 = (self__.level + (1));
while(true){
if((i_38411 <= (new_level + (1)))){
(update[i_38411] = self__.header);

var G__38412 = (i_38411 + (1));
i_38411 = G__38412;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_38413 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_38413[i]));
} else {
x__$2.forward.push((((i < links_38413.length))?(links_38413[i]):null));
}

if((i < links_38413.length)){
(links_38413[i] = x__$2);
} else {
links_38413.push(x__$2);
}
...
var i_38417 = (0);
while(true){
if((i_38417 <= self__.level)){
var links_38418 = (update[i_38417]).forward;
if((x__$1 === (((i_38417 < links_38418.length))?(links_38418[i_38417]):null))){
(links_38418[i_38417] = (x__$1.forward[i_38417]));

var G__38419 = (i_38417 + (1));
i_38417 = G__38419;
continue;
} else {
var G__38420 = (i_38417 + (1));
i_38417 = G__38420;
continue;
}
} else {
...
var G__38425 = nx;
var G__38426 = (level__$1 - (1));
x = G__38425;
level__$1 = G__38426;
continue;
} else {
var G__38428 = x;
var G__38429 = (level__$1 - (1));
x = G__38428;
level__$1 = G__38429;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__38431 = nx;
var G__38432 = (level__$1 - (1));
x = G__38431;
level__$1 = G__38432;
continue;
} else {
var G__38433 = x;
var G__38434 = (level__$1 - (1));
x = G__38433;
level__$1 = G__38434;
continue;
}
