...
var len__5749__auto___38375 = arguments.length;
var i__5750__auto___38376 = (0);
while(true){
if((i__5750__auto___38376 < len__5749__auto___38375)){
args_arr__5774__auto__.push((arguments[i__5750__auto___38376]));

var G__38377 = (i__5750__auto___38376 + (1));
i__5750__auto___38376 = G__38377;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq38309){
...
var G__38312 = cljs.core.first(seq38309__$2);
var seq38309__$3 = cljs.core.next(seq38309__$2);
var G__38313 = cljs.core.first(seq38309__$3);
var seq38309__$4 = cljs.core.next(seq38309__$3);
var G__38314 = cljs.core.first(seq38309__$4);
var seq38309__$5 = cljs.core.next(seq38309__$4);
var G__38315 = cljs.core.first(seq38309__$5);
var seq38309__$6 = cljs.core.next(seq38309__$5);
var self__5734__auto__ = this;
return self__5734__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38310,G__38311,G__38312,G__38313,G__38314,G__38315,seq38309__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__38364){
var vec__38365 = p__38364;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38365,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38365,(1),null);
